export default class Triangle {
    ...
    intersects(rect) {
        return (this.x-4 < rect.x + rect.h)
            && (rect.x < this.x+4 + this.h)
    ...
    smartintersects(fi) {
        if (fi.constructor.name === "Circle") {
            ...
            for (let i = 0; i < 3; i++)
            {
                if (i === 0) {x1 = this.x+27;  y1 = this.y;  x2 = this.x+54;  y2 = this.y+50}
                if (i === 1) {x1 = this.x+54;  y1 = this.y+50;  x2 = this.x-4;  y2 = this.y+50}
                if (i === 2) {x1 = this.x-4;  y1 = this.y+50;  x2 = this.x+27;  y2 = this.y}
                k = ((y2-y1)/(x2-x1))
                c = y1 - (k*x1)
