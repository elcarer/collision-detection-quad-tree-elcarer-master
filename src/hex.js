export default class Hex {
    ...
    smartintersects(fi) {
        if (fi.constructor.name === "Circle") {
            ...
            for (let i = 0; i < 6; i++)
            {
                if (i === 0) {x1 = this.x+25;  y1 = this.y;  x2 = this.x+50;  y2 = this.y+13}
                if (i === 1) {x1 = this.x+50;  y1 = this.y+13;  x2 = this.x+50;  y2 = this.y+38}
                if (i === 2) {x1 = this.x+50;  y1 = this.y+38;  x2 = this.x+25;  y2 = this.y+50}
                if (i === 3) {x1 = this.x+25;  y1 = this.y+50;  x2 = this.x;  y2 = this.y+38}
                if (i === 4) {x1 = this.x;  y1 = this.y+38;  x2 = this.x;  y2 = this.y+13}
                if (i === 5) {x1 = this.x;  y1 = this.y+13;  x2 = this.x+25;  y2 = this.y}
                k = ((y2-y1)/(x2-x1))
                c = y1 - (k*x1)
